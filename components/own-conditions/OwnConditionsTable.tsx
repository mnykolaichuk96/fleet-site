...
export default function OwnConditionsTable() {
    ...
    useEffect(() => {
        const timer = setTimeout(() => setTableEntered(true), 150);
    ...
    return (
      ...
      0%
                    ...
                    <div
                        ...
                        `}
                    >
                        <div className="grid grid-cols-2 items-center mb-4 text-sm font-semibold text-gray-500">
                            ...
                            {commission.tiers.map((tier, index) => (
                                <div
                                    ...
                                    className={`
                                        ...
                                        rounded-xl px-5 py-4 transition-colors duration-200
                                        ${
                                        tier.fee.highlight
                                            ? "bg-[#FFF7ED] hover:bg-[#FFF1DD]"
                                ...
                                >
                                    ...
                                    >
                                        {tier.range} {commission.currency}
                                    </span>
                                    ...
                                    >
                                        {tier.fee.amount} {commission.currency}{" "}
                                        <span
                                            className={
                                                tier.fee.highlight
                                                    ? "text-[#D97706]/70 text-sm"
